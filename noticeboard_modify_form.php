...
<?php
	...
	$pwd=$row["pass"];
?>
	    <form  name="noticeboard_form" method="post" action="noticeboard_modify.php?num=<?=$num?>&page=<?=$page?>" enctype="multipart/form-data">
	    	 <ul id="noticeboard_form">
				...
				<li>
					...
					<span class="col2"><input name="subject" type="password" value="<?=$pwd?>"></span>
				</li>		
